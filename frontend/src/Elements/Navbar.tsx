      ...
      <nav className="bg-[#1F2135] text-white px-6 lg:px-32 py-5 flex justify-between items-center">
        <div className="text-lg font-bold flex items-center w-1/3">
          <Link to="/" className="flex items-center">
            ...
            <span className="pt-1">Chess Site</span>
          </Link>
        </div>

        <div className="hidden md:flex justify-center space-x-10 w-1/3 px-4">
          <Link to="/" className="hover:text-purple-500">Home</Link>
          <Link to="/" className="hover:text-purple-500">Edit</Link>
          <Link to="/game" className="hover:text-purple-500">Play</Link>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50" onClick={closeSidebar}>
          ...
          >
            ...
            <nav className="space-y-4">
              <Link to="/" className="block hover:text-purple-500" onClick={closeSidebar}>Home</Link>
              <Link to="/" className="block hover:text-purple-500" onClick={closeSidebar}>Post</Link>
              <Link to="/" className="block hover:text-purple-500" onClick={closeSidebar}>Edit</Link>
              <Link to="/" className="block hover:text-purple-500" onClick={closeSidebar}>Room</Link>
